...
class TestUser(unittest.TestCase):
	...
	def test__init__(self):
		...
		'''
		self.assertEqual(self.new_credential.user_name,'Kimeu')
		self.assertEqual(self.new_credential.site_name,'Facebook')
		self.assertEqual(self.new_credential.account_name,'Kimeu')
		self.assertEqual(self.new_credential.password,'password789')
